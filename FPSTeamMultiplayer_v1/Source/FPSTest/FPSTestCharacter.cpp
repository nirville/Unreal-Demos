...
void AFPSTestCharacter::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	Super::GetLifetimeReplicatedProps(OutLifetimeProps);

	DOREPLIFETIME(AFPSTestCharacter, Task);
}
...
void AFPSTestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AFPSTestCharacter::StartFiring);
	PlayerInputComponent->BindAction("Fire", IE_Released, this, &AFPSTestCharacter::StopFiring);
...
void AFPSTestCharacter::StartFiring()
{
	PerformTask(ETaskEnum::Fire);
}

void AFPSTestCharacter::StopFiring()
{
	PerformTask(ETaskEnum::None);
}


void AFPSTestCharacter::PerformTask(ETaskEnum::Type NewTask)
{
...
void AFPSTestCharacter::ServerPerformTask_Implementation(ETaskEnum::Type NewTask)
{
	PerformTask(NewTask);
}

bool AFPSTestCharacter::ServerPerformTask_Validate(ETaskEnum::Type NewTask)
{
	return true;
}
...
void AFPSTestCharacter::OnFire()
{
	...
	GetWorldTimerManager().SetTimer(TimerHandle_Task, this, &AFPSTestCharacter::OnFire, 0.1f);
}
...
FRotator AFPSTestCharacter::GetViewRotation() const
{
	if (Controller)
	{
...
float AFPSTestCharacter::TakeDamage(float DamageAmount, const FDamageEvent& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
	Health -= DamageAmount;
	if (Health < 0.f)
	{
...
void AFPSTestCharacter::OnRep_Task()
{
	switch (Task)
	{
	case (ETaskEnum::None):
...
void AFPSTestCharacter::OnRep_Health()
{
